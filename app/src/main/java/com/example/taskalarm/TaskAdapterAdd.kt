...
class TaskAdapterAdd(private val tasks: List<String>) :
    RecyclerView.Adapter<TaskAdapterAdd.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.deletarButton.setOnClickListener{
            AddActivity.tarefas.removeAt(position)
            AddActivity.tasksRv!!.adapter = TaskAdapterAdd(tasks)
        }
    }
